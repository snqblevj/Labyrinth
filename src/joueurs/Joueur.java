...
public abstract class Joueur {
     ...
     * Egalement indiquée. Aucun objet n'est attribué au joueur (l'attribut objetsJoueur vaudra null après la construction du joueur).
     *
     * @param numJoueur Le numéro du joueur.
     * @param nomJoueur Le nom du joueur.
     * @param numeroImagePersonnage Le numÃ©ro de l'image représentant le joueur.
    ...
    /**
     *
     * MÃ©thode permettant de créer des joueurs à partir de paramètres obtenus à partir des fenêtres de paramètrages.
     * Les joueurs sont positionnés dans les différents coins du plateau en fonction de leur rang
     * (le premier au coin en haut Ã  gauche, le deuxième au coin en haut à droite, le troisième en bas à droite).
     * Le joueur de numéro 0 est le premier élément du tableau retourné, le joueur de numéro 1 est le deuxiéme élément du tableau retourné et
     ...
     * et une entrée (une flèche) dans le plateau. Ce choix se fera à travers l'interface graphique pour un joueur humain et par calcul pour un joueur
    ...
    /**
     *
     * Cette méthode est appelée lorsque le joueur doit se déplacer et donc choisir une case sur le plateau. Pour un joueur humain ce choix se fera Ã  l'aide
     ...
     *
     * @param elementsPartie Les éléments de la partie.
     * @return Un tableau contenant deux entiers, le premier correspond à la ligne de la case choisie, le second Ã  la colonne de la case choisie.
     */
