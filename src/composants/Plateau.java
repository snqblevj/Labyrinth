...
public class Plateau {
    ...
    public void calculeChemin(int posLigCaseDep, int posColCaseDep, int posLigCaseArr, int posColCaseArr) {
        int cheminlst = 1;
        int resultats[][] = null;
        int start[] = new int[]{posLigCaseDep, posColCaseDep};
        int goal[] = new int[]{posLigCaseArr, posColCaseArr};
        ...
        int[][] path = new int[][]{new int[]{posLigCaseDep, posColCaseDep}};
        while (path.length > 0) {
            int min = 0;
            for (int i = 0; i < path.length; i++) {
                if (path[i].length < path[min].length) {
                    min = i;
                }
            }
